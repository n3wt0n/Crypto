...
namespace DBTek.Crypto.Helpers
{
    ...
    internal class MD5
    {
        ...
        public static byte[] GetHash(string input)
            => GetHash(input, new UTF8Encoding());        
        ...
        public static string GetHashString(string input, Encoding encoding)
        {
            ...
            if (null == encoding)            
                throw new System.ArgumentNullException(nameof(encoding), "Unable to calculate hash over a string without a default encoding. Consider using the GetHashString(string) overload to use UTF8 Encoding");
        ...
        public static string GetHashString(string input)
            => GetHashString(input, new UTF8Encoding());        
